...
--ZADATAK 1.15
--Izracunajte prosjecnu ocjenu za studente ccije prezime pocinje s „k“ i imaju prosjek ocjena veci od 2. Rezultat sortirajte prema prezimenu, pa ocjeni.
--Rješenje:
...
--ZADATAK 1.20
--Svakom nastavniku je pridružen koeficijent. Grupirajte nastavnike u grupe 1, 2, 3, 4, .. itd. prema koeficijentu (ako nastavnik ima koeficijent 5.4 onda spada u grupu 5, ako ima 9.4 onda u grupu 9 itd.). Ispišite koliko nastavnika ima u svakoj grupi, te koliki je prosjecni koeficijent svake grupe.
--Rješenje:



--ZADATAK 1.21
--Prebrojite koliko svaka nadreðena organizacijska jedinica ima podredzenih organizacijskih jedinica. Neke organizacijske jedinice nemaju nadreðenih, kako to možemo procitati iz upita i koliko je takvih? Posebno ispišite tu
--informaciju.
--Rješenje:
...
--ZADATAK 1.22
--Koliko ima upisanih studenata po organizacijskim jedinicama i broj predmeta na svakom zavodu.
--Rješenje:
